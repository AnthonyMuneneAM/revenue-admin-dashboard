<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLand"
            aria-expanded="true" aria-controls="collapseLand">
            <i class="fa-solid fa-city"></i>
            <span>Land & Urban Planning</span>
        </a>
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBorder"
            aria-expanded="true" aria-controls="collapseBorder">
            <i class="fa-solid fa-road-barrier"></i>
            <span>Border Revenue</span>
        </a>
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOutdoor"
            aria-expanded="true" aria-controls="collapseOutdoor">
            <i class="fa-solid fa-rectangle-ad"></i>
            <span>Outdoor Advertisement</span>
        </a>
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseHealth"
            aria-expanded="true" aria-controls="collapseHealth">
